...
namespace MarksMusicStore.Repository
{
	public class GenericRepository<Tbl_Entity> : IRepository<Tbl_Entity> where Tbl_Entity : class
	{
		DbSet<Tbl_Entity> _dbSet;
		private dbMarksOnlineStoreEntities _DBEntity;

		public GenericRepository(dbMarksOnlineStoreEntities DBEntity)
		{
			_DBEntity = DBEntity;
			_dbSet = DBEntity.Set<Tbl_Entity>();
		}

		public void All(Tbl_Entity entity)
		{
			_dbSet.Add(entity);
